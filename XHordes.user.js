...
(function(){
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(ev) {
            document.open();
            let index = ev.responseText.replace('<script src="script/dist.min.js"></script>', '<script src="https://cdn.rawgit.com/LegusX/xhordes/4e8d42fe/src/1-3-1/xhordes.js"></script> ');
