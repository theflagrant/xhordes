...
(function(){
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(ev) {
            document.open();
            let index = ev.responseText.replace('<script src="script/dist.min.js"></script>', '<script src="https://cdn.rawgit.com/LegusX/xhordes/master/src/xhordes1-0HOTFIX.js"></script> ');
